            ...
            <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Password (Optional) -->
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-2" style="color: #374151;">New Password (Leave blank to keep current)</label>
                            <input type="password" 
                                   id="password" 
                                   name="password" 
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2" style="color: #374151;">Confirm New Password</label>
                            <input type="password" 
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                ...
                                <span style="color: #ffffff;">Update User</span>
                            </button>
                        </div>
                    </div>
                </form>
