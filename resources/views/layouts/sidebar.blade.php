<aside class="hidden md:flex md:flex-col w-64 min-h-screen bg-purple-900 text-white">
    ...
    <nav class="flex-1 px-0 pt-0 pb-4 space-y-1 overflow-y-auto">
        ...
        @if(auth()->user()?->isSuperAdmin())
        <a href="{{ route('admin.messaging') }}" class="flex items-center gap-3 px-0 py-2 rounded-lg hover:bg-purple-800 @if(request()->routeIs('admin.messaging*')) bg-green-200 text-purple-900 font-semibold @endif">
